...
"""
The purpose of this program is to analyze personal Netflix viewing activity.
Help from:
https://catris25.medium.com/visualizing-my-netflix-viewing-activity-with-python-and-matplotlib-2078e43892
https://catris25.medium.com/visualizing-my-netflix-viewing-activity-with-python-and-matplotlib-part-ii-4d7c7b85ea4a
"""
...
def separate_types_of_content(df):
    """
...
def ask_for_title(df, content_type):
    """
...
def conduct_analysis(df, analysis, profile, content_type, title):
    """
...
def countries_analysis(df, profile, content_type, title):
    """
...
def devices_analysis(df, profile, content_type, title):
    '''
...
def viewing_frequency_analysis(df, profile, content_type, title):
    """
...
def viewing_activity_analysis(df, profile, content_type, title):
    """
...
def viewing_heat_map(df, profile, content_type, title):
    """
...
def most_watched_movies_analysis(df, profile):
    """
...
def most_watched_shows_analysis(df, profile):
    """
...
def most_watched_episodes_analysis(df, profile, title):
    """
...
def most_watched_days_analysis(df, profile, content_type, title):
    """
...
def duration_analysis(df, profile, content_type, title):
    """
